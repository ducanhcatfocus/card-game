...
public class UIManager : Singleton<UIManager>
{
    ...
    public void SetCardDeckAmount(int drawPileCount, int discardPileCount)
    {
        gamePlayCanvas = Ins.GetUI<GamePlay>();
        gamePlayCanvas.SetPileTexts(drawPileCount, discardPileCount);
    }
